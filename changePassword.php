...
if(isset($_POST['change'])){
    ...
    $sql = "select studentPassword from student where studentName = '$student';";
    $result = mysqli_query($connectivity, $sql);
    $row=mysqli_fetch_assoc($result);
    if($old==$row['studentPassword']){
        if($new==$confirm){
            $query = "update student set studentPassword='$confirm' where studentName='$student';";
